...
import ru.kode.base.internship.ui.ProductsMainScreen.ViewIntents
...
import ru.kode.base.internship.utils.drawable
import ru.kode.base.internship.utils.icon
import ru.kode.base.internship.utils.stringId
    ...
    Surface(
      ...
      Row(verticalAlignment = Alignment.CenterVertically) {
        ...
        Column(modifier = Modifier.weight(1f)) {
          ...
          Text(bankAccount.sum, color = AppTheme.colors.contendAccentPrimary, style = AppTheme.typography.body2)
          Spacer(modifier = Modifier.height(14.dp))
        }
        Surface(
          modifier = Modifier
